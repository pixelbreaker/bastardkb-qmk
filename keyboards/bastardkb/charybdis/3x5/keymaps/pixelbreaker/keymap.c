...
const uint16_t PROGMEM combo_symbols[]   = {BSP_NUM, ENT_FUN, COMBO_END};
const uint16_t PROGMEM combo_winswitch[] = {KC_C, KC_V, COMBO_END};
const uint16_t PROGMEM combo_tabswitch[] = {KC_E, KC_R, COMBO_END};
const uint16_t PROGMEM combo_grv[]       = {KC_O, KC_P, COMBO_END};
const uint16_t PROGMEM combo_scln[]      = {LALT_T(KC_L), RCTL_T(KC_QUOT), COMBO_END};
...
#define ________MOUSE_BUTS_______   KC_BTN3, KC_BTN1, KC_BTN2
...
// Mouse (Auto)
    ...
    _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, \
    _______, SNIPE,   ________MOUSE_BUTS_______,    ________MOUSE_BUTS_______, _______, _______, \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_wrapper(
    MOUSE_MOD(HOME_ROW_MOD_CAGS(LAYOUT_BASE_QWERTY))
  ),
...
report_mouse_t pointing_device_task_user(report_mouse_t mouse_report) {
    ...
    if (track_mode != CURSOR || winswitch_active || tabswitch_active || mouse_pause) {
